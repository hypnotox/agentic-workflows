...
(`awf prose-gate`, ADR-0119, opt-in for adopters and enabled in this repo), and the working-memory
citation scan (`awf memory-gate`, ADR-0158, opt-in for adopters and enabled in this repo). A red gate blocks the commit: fix the cause or revert.
