...
Edge: The Sundial Pi and Claude proposing/reviewer outputs and Sundial AGENTS guide carry the same generic anchors without awf-specific paths, numbered ADR citations, unresolved values, or a literal current authoring format instruction; both awf lock files record the rendered hashes.
Post-check: Run `./x check`; run `git diff --check`; run `! rg -n 'Required frontmatter:.*current-state-v3|format.*\(`current-state-v[0-9]+`\)' .pi/skills/*-proposing-adr/SKILL.md .claude/skills/*-proposing-adr/SKILL.md examples/sundial/.pi/skills/*-proposing-adr/SKILL.md examples/sundial/.claude/skills/*-proposing-adr/SKILL.md`; run `git diff --name-only | while IFS= read -r path; do case "$path" in templates/*|internal/catalog/standard.go|internal/project/*_test.go|.awf/parts/adr-template/body.md|.awf/skills/parts/writing-plans/conventions-tasks.md|.awf/agents/adr-reviewer.yaml|.awf/awf.lock|AGENTS.md|.pi/agents/adr-reviewer.md|.pi/skills/awf-{brainstorming,proposing-adr,writing-plans}/SKILL.md|.claude/agents/adr-reviewer.md|.claude/skills/awf-{brainstorming,proposing-adr,writing-plans}/SKILL.md|docs/decisions/README.md|docs/decisions/template.md|docs/plans/README.md|examples/sundial/.awf/awf.lock|examples/sundial/AGENTS.md|examples/sundial/.pi/agents/adr-reviewer.md|examples/sundial/.pi/skills/sundial-{brainstorming,proposing-adr,writing-plans}/SKILL.md|examples/sundial/.claude/agents/adr-reviewer.md|examples/sundial/.claude/skills/sundial-{brainstorming,proposing-adr,writing-plans}/SKILL.md) ;; *) printf 'unexpected changed path: %s\n' "$path"; exit 1;; esac; done`; every command must reach a clean or zero-finding terminal state.
