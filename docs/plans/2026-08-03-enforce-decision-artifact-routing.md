...
Paths: ["templates/agents/adr-reviewer.md.tmpl", "internal/catalog/standard.go", "internal/configspec/spec.go", ".awf/parts/adr-template/body.md", ".awf/skills/parts/writing-plans/conventions-tasks.md", ".awf/agents/adr-reviewer.yaml"]
...
The repo-local audit then identified the adopter-facing change as missing an Unreleased changelog
entry; the terminal review transaction added the entry before closure.
