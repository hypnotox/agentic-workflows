...
Paths: ["internal/authoringop/authoring_test.go", "internal/authoringop/resolver_test.go", "internal/publisher/inplace_test.go", "internal/clispec/clispec_test.go", "cmd/awf/authoring_test.go", "cmd/awf/help_test.go", "cmd/awf/global_help_test.go"]
