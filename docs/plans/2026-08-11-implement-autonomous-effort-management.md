...
Settlement-review refinement: renewed review found that the first scanner revision was line-bound and polarity-blind and that exact-phrase switching-owner bans could reject references while missing paraphrased ownership. The parent confined obsolete-policy scanning to genuine guidance surfaces, made its patterns multiline and negation-aware, and added multiline forbidden plus negated-compliant fixtures. It replaced phrase bans with an ownership classifier that requires active-effort, switch, keep/resume, and discontinue/archive semantics together, proving both a paraphrased duplicate owner and a permitted delegation reference. These reasoned test refinements preserve the implemented policy and its historical exclusions.
