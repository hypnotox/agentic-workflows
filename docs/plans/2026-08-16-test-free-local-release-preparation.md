...
Paths: ["internal/project/VERSION", "internal/project/project.go", "internal/project/version_test.go", "cmd/versioncheck/main.go", "cmd/versioncheck/main_test.go", "x", "internal/project/gate_runner_test.go", ".github/workflows/release.yml", "cmd/releasecheck/main.go", "cmd/releasecheck/main_test.go"]
