...
Post-check: "Before Task 2.2, inspect the five claim-source diffs against the ADR and run ./awf context --show invariants --show evidence --show pending on those paths; require exactly the eight intended claim mutations, every proof marker resolved to its named live test, no unrelated claim mutation, and all operations still reported Remaining until the paired lifecycle edit lands."
