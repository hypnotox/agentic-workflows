...
- [ ] **Task 1.5: Embed the complete routine protocol at the per-task boundaries** (ADR-0152 Decision item 5):
...
- [ ] **Task 1.9: Rewrite the workflow-template tests to the boundary classification** (ADR-0152 Decision item 11):
