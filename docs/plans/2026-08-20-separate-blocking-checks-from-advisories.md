...
- Integration retained main's daily-guide simplification rather than restoring rare check protocol in `docs/working-with-awf.md`. The exhaustive check severity inventory moved to the maintained testing source beside the gate severity contract, preserving one verification owner and the approved AF-013 documentation outcome.
