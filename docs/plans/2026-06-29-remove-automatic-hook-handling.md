...
- [ ] **Task 3.9 — Kind-related doc edits.**
  ...
  - `cmd/awf/main.go` line 1 package doc comment: "renders standardised .claude skills, review agents, and git hooks into a project" → drop "and git hooks".
