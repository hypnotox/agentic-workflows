...
- **Modified:** `internal/adr/adr.go` (the `cites:` pattern, the `Relation` doc comment),
  ...
  `.awf/agents-doc.yaml`, `docs/decisions/README.md`, `docs/roadmap.md`, twelve ADR files under
  `docs/decisions/` (Phase 2), `docs/decisions/0131-*.md` (status flip), and the rendered artifacts
