...
- 2026-08-10 Phase 2 review: Strengthened the ownership and fan-out proofs across domain boundaries, TopicsForPath, and marker applicability; pinned the new and retired CLI labels; and recorded the schema-41 compatibility break in the Unreleased changelog.
