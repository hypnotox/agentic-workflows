...
Implementation range: 6ce178c9d3db433b246dde8ddc6b89517b84ceec..0b43ad610b15080d9d26c089ad232e194e735ad3
Touched paths:
- ".awf/agents-doc.yaml"
- ".awf/awf.lock"
...
- ".awf/topics/parts/tooling/filesystem-access/current-state.md"
...
- ".claude/skills/awf-effort-workflow/SKILL.md"
...
- ".pi/skills/awf-effort-workflow/SKILL.md"
...
- ".pi/skills/awf-using-effort/SKILL.md"
...
- "cmd/awf/uninstall.go"
- "cmd/awf/upgrade.go"
- "cmd/awf/upgrade_presentation.go"
- "cmd/awf/upgrade_presentation_test.go"
- "cmd/awf/upgrade_test.go"
- "cmd/pincheck/main.go"
- "cmd/pincheck/main_test.go"
...
- "docs/decisions/0305-preserve-brainstorming-continuity-before-handoff.md"
- "docs/decisions/0306-prepare-ordinary-context-without-full-rendering.md"
- "docs/decisions/0307-serialize-project-mutations-by-physical-root.md"
- "docs/decisions/0308-bind-repository-and-release-acceptance-to-exact-revisions.md"
- "docs/decisions/0309-bind-implementation-subagent-execution-to-the-selected-checkout.md"
- "docs/decisions/0310-require-complete-and-unambiguous-mutable-authority.md"
- "docs/decisions/0311-bind-terminal-plan-closure-to-selected-implementation-evidence.md"
- "docs/decisions/INDEX.md"
- "docs/decisions/bind-implementation-subagent-execution-to-the-selected-checkout.md"
- "docs/decisions/bind-repository-and-release-acceptance-to-exact-revisions.md"
- "docs/decisions/bind-terminal-plan-closure-to-selected-implementation-evidence.md"
- "docs/decisions/prepare-ordinary-context-without-full-rendering.md"
- "docs/decisions/preserve-brainstorming-continuity-before-handoff.md"
- "docs/decisions/require-complete-and-unambiguous-mutable-authority.md"
- "docs/decisions/serialize-project-mutations-by-physical-root.md"
- "docs/known-issues.md"
- "docs/pi-runtime-reference.md"
- "docs/plans/2026-08-26-close-v0-40-0-review-baseline.md"
- "docs/plans/2026-08-26-speed-up-ordinary-context-queries.md"
...
- "internal/adr/corpus.go"
- "internal/adr/corpus_test.go"
- "internal/adr/export_test.go"
- "internal/adr/format_test.go"
- "internal/adr/pending_test.go"
- "internal/adr/renumber.go"
- "internal/adr/renumber_fault_test.go"
- "internal/adr/renumber_test.go"
- "internal/adr/scaffold_lock.go"
- "internal/adr/scaffold_lock_other.go"
- "internal/adr/scaffold_lock_other_test.go"
- "internal/adr/scaffold_lock_test.go"
- "internal/adr/scaffold_lock_windows.go"
- "internal/adr/scaffold_lock_windows_test.go"
- "internal/catalog/standard.go"
- "internal/checkop/checkstaged_test.go"
- "internal/checkop/version_test.go"
- "internal/clispec/clispec.go"
- "internal/config/config.go"
- "internal/config/config_test.go"
- "internal/config/strictyaml.go"
- "internal/config/tree_reader_test.go"
...
- "internal/currentstatecoord/number.go"
- "internal/currentstatecoord/number_test.go"
- "internal/currentstatecoord/terminal_transition_test.go"
- "internal/domainop/domain.go"
- "internal/domainop/domain_test.go"
- "internal/effort/archive_test.go"
- "internal/effort/rollback_identity_test.go"
- "internal/effort/service.go"
- "internal/effort/service_test.go"
- "internal/effort/types.go"
- "internal/effort/wiring_test.go"
- "internal/effortop/operation.go"
- "internal/effortop/operation_test.go"
- "internal/evals/fixture_test.go"
- "internal/evals/independent_workflow_escalation_test.go"
- "internal/evals/plan_flexibility_test.go"
- "internal/filepublication/anchored.go"
- "internal/filepublication/publication_darwin.go"
- "internal/filepublication/publication_linux.go"
- "internal/filepublication/publication_other.go"
- "internal/filepublication/publication_windows.go"
- "internal/filesystem/canonical_root_other.go"
- "internal/filesystem/canonical_root_windows.go"
- "internal/filesystem/directory.go"
- "internal/filesystem/expected_commit.go"
- "internal/filesystem/expected_commit_darwin.go"
- "internal/filesystem/expected_commit_linux.go"
- "internal/filesystem/expected_commit_linux_test.go"
- "internal/filesystem/expected_commit_other.go"
- "internal/filesystem/expected_commit_windows.go"
- "internal/filesystem/handle.go"
- "internal/filesystem/handle_test.go"
- "internal/filesystem/lease.go"
- "internal/filesystem/lease_test.go"
- "internal/filesystem/tree_entry.go"
- "internal/filesystem/tree_entry_test.go"
- "internal/git/entrypoints_test.go"
- "internal/git/git_test.go"
- "internal/git/handle.go"
- "internal/git/terminal_paths_test.go"
- "internal/git/walk.go"
- "internal/git/walk_test.go"
- "internal/initop/init.go"
- "internal/initop/init_test.go"
- "internal/initspec/presentation.go"
- "internal/localdocop/localdoc.go"
- "internal/localdocop/localdoc_test.go"
- "internal/manifest/manifest.go"
- "internal/manifest/manifest_test.go"
- "internal/plan/export_test.go"
- "internal/plan/plan.go"
- "internal/plan/plan_test.go"
- "internal/plan/publication_test.go"
- "internal/plan/source.go"
- "internal/plan/source_test.go"
- "internal/plan/terminal.go"
- "internal/plan/terminal_test.go"
- "internal/plancheck/terminal.go"
- "internal/plancheck/terminal_test.go"
- "internal/project/adrnumber_test.go"
- "internal/project/agent_template_test.go"
- "internal/project/audit_inputs_test.go"
- "internal/project/authoring_workflow_template_test.go"
- "internal/project/commit_authorization_test.go"
...
- "internal/project/incremental_adr_lifecycle_test.go"
- "internal/project/install_test.go"
- "internal/project/layout.go"
- "internal/project/mergeaggregate_test.go"
...
- "internal/project/staged_test_helpers_test.go"
- "internal/project/tree_reader.go"
- "internal/project/tree_reader_unix_test.go"
- "internal/project/version_test.go"
- "internal/projectlicense/license.go"
- "internal/projectlicense/license_test.go"
...
- "internal/publisher/result_test.go"
...
- "internal/resident/resident.go"
- "internal/resident/resident_test.go"
...
- "internal/topic/corpus.go"
- "internal/topic/provenance.go"
- "internal/topic/provenance_test.go"
- "internal/topic/scaffold.go"
- "internal/topic/scaffold_test.go"
- "internal/topicop/legacy_scaffold_test.go"
- "internal/topicop/scaffold.go"
- "internal/topicop/scaffold_test.go"
- "internal/upgrade/journal.go"
- "internal/upgrade/journal_test.go"
- "internal/upgrade/operation.go"
- "internal/upgrade/operation_migration_journal_test.go"
- "internal/upgrade/operation_presentation.go"
- "internal/upgrade/operation_test.go"
- "internal/worktree/manager.go"
- "internal/worktree/manager_test.go"
- "internal/worktree/presentation.go"
- "internal/worktree/topology.go"
- "internal/worktree/wiring_test.go"
...
- "templates/skills/effort-workflow/SKILL.md.tmpl"
...
- "x"
Material deviations:
- Phase 1 implementation preceded its required claim settlement; review introduced the focused mutable-authority ADR and a separate Phase 2 authority transaction before later work resumed.
- Phase 3 expanded the planned confined primitives to released-platform root-anchored native commits and identity-bearing exclusive directory publication after review exposed parent-relocation, symlink, and ownership races.
- Phase 4 widened its writer census and split its transaction across reviewed settlements to remove parallel unleased writers, bind handles to lease identities, and preserve exact partial topology and cleanup effects.
- Phase 5 replaced guessed or absent acceptance ranges with unconditional fail-conservative mutation execution, selected only valid stable release tags, and strengthened structured workflow and exact-SHA evidence parsing.
- Phase 6 corrected the planned runtime boundary because pi-tools supplies prepared child CWD but not confinement; awf now aligns validated child execution and verification while retaining the explicit non-confinement residual.
- Phase 7 added a focused ADR and current-state claim for terminal-plan enforcement, then replaced status-diff marker checks with parsed full-history reconciliation.
- Phase 8 limited portable ownership normalization to Linux archives and added exact checksum, cleanup, and structured-error evidence instead of changing all target metadata.
- Phase 9 applied the hosted controls through the repository's existing main ruleset and a new release-tag ruleset, with exact API read-back and a non-publishing probe.
- Finalization merged concurrent main development before ADR numbering, reconciled its strict-lock and coverage effects, and landed two reviewed post-integration project-tree fixes before terminal closure.
