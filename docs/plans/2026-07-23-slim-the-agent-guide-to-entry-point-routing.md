...
| 8 | Pi telemetry workflow paragraph (L67) | delete | `workflow.md.tmpl` L20 carries the template copy (currently unreachable in the neutral doc render, matching the evicted guide copy) | none |
