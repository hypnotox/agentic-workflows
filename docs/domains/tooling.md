...
- [Authority Queries](../topics/tooling/authority-queries.md): Read-only commands that expose current-state authority and decision history without duplicating code navigation.
...
- [Upgrade runtime](../topics/tooling/upgrade-runtime.md): The supported ordered live-schema migration runtime.
