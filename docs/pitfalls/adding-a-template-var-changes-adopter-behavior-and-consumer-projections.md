...
<!-- awf:source .awf/docs/pitfalls/adding-a-template-var-changes-adopter-behavior-and-consumer-projections.md -->
# Adding a template var changes adopter behavior and consumer projections

**Domains:** rendering

**Tags:** placeholder-degradation, publication-safety
