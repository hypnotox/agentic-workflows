...
<!-- awf:edit gate — default; create .claude/awf/docs/parts/testing/gate.md to override -->
## The gate
...
<!-- awf:edit tiers — default; create .claude/awf/docs/parts/testing/tiers.md to override -->
## Tiers
...
<!-- awf:edit layout — default; create .claude/awf/docs/parts/testing/layout.md to override -->
## Test layout
