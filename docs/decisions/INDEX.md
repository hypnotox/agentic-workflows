...
- [ADR-simplify-pi-effort-association-around-fixed-repository-paths: Simplify Pi effort association around fixed repository paths](simplify-pi-effort-association-around-fixed-repository-paths.md) (Proposed)
