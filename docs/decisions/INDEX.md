...
- [ADR-separate-commit-and-full-verification-gates: Separate commit and full verification gates](separate-commit-and-full-verification-gates.md) (Implementing)
