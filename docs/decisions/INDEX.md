...
- [ADR-0189: Replace the global state sequence with ADR-number provenance order](0189-replace-the-global-state-sequence-with-adr-number-provenance-order.md) (Implementing)
