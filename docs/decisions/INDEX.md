...
- [ADR-decouple-adr-application-completion-from-terminal-review: Decouple ADR Application Completion from Terminal Review](decouple-adr-application-completion-from-terminal-review.md) (Implementing)
