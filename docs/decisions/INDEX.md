...
- [ADR-deduplicate-plan-authoring-and-execution-workflow: Deduplicate Plan Authoring and Execution Workflow](deduplicate-plan-authoring-and-execution-workflow.md) (Proposed)
