...
- [ADR-move-context-query-input-below-application-coordination: Move Context Query Input Below Application Coordination](move-context-query-input-below-application-coordination.md) (Proposed)
