...
date: 2026-07-30
---
# ADR-0181: Severity-key removal preserves values, not bytes

## Context

`config/migrations-and-locks:severity-keys-dropped` promises that schema generation 24 "leaves every
...
The wording is inherited: it entered with ADR-0179 and ADR-0180 corrected the second half of the same
...
- 2026-07-30: Proposed
- 2026-07-30: Implemented; content-sha256: 06f31e25383b72f23524a69a63a118d2448d77b85fb8c3088bcfafeb894f29ce; state-sequence: 94
