...
<!-- awf:template-source templates/adr-readme/README.md.tmpl -->
# Architecture Decision Records

<!-- awf:template-source templates/adr-readme/README.md.tmpl#intro -->
...
<!-- awf:template-source templates/adr-readme/README.md.tmpl#when -->
...
<!-- awf:template-source templates/adr-readme/README.md.tmpl#naming -->
...
<!-- awf:template-source templates/adr-readme/README.md.tmpl#frontmatter -->
...
<!-- awf:template-source templates/adr-readme/README.md.tmpl#lifecycle -->
...
Operations are nonempty, previously unapplied, duplicate-free membership in any authored order.
Entering Implementing appends its status then the first Applied event; every later Applied event,
including the final batch, leaves status Implementing, and settled review later appends only
Implemented. Direct Implemented transitions use one implicit batch. Throughout Implementing, an
already-applied add or update may be corrected with `- YYYY-MM-DD: Reapplied; operations: <verb>
`<qualified-id>`[, ...]`. The operation must have an earlier Applied occurrence, each correction is
one material checked batch, and provenance stays unchanged; Reapplied removes and terminal
corrections are refused. Per-claim provenance is ordered by ascending final ADR number. Stable
history is corrected forward through a successor ADR, never by deleting or mutating a retained event.

<!-- awf:template-source templates/adr-readme/README.md.tmpl#state-changes -->
...
<!-- awf:template-source templates/adr-readme/README.md.tmpl#index -->
