...
- 2026-07-26: Applied; operations: update `tooling/workflow-telemetry:event-protocol-and-ledger`
- 2026-07-26: Applied; operations: update `tooling/workflow-telemetry:effort-lifecycle-and-routes`, update `tooling/workflow-telemetry:trajectory-and-derived-effort-model`
- 2026-07-26: Applied; operations: add `tooling/workflow-telemetry:external-adoption-boundary`
- 2026-07-26: Applied; operations: add `tooling/workflow-telemetry:derived-detour-return`
- 2026-07-26: Applied; operations: update `tooling/workflow-telemetry:privacy-integrity-and-retention`, update `tooling/workflow-telemetry:canonical-projections-and-diagnostics`
- 2026-07-26: Applied; operations: update `rendering/pi-workflows:pi-lifecycle-enforcing-workflow-router`, update `rendering/pi-workflows:pi-workflow-dashboard-public-contract`, update `rendering/guide-and-doc-templates:working-memory-single-home`, update `rendering/adapter-outputs:pi-workflow-dashboard-runtime`, update `rendering/pi-runtime:pi-real-runtime-smoke`
