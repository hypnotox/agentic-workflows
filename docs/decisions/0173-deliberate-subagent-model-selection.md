...
- 2026-07-29: Applied; operations: add `rendering/workflow-skill-templates:deliberate-subagent-model-selection`
- 2026-07-29: Applied; operations: update `rendering/pi-workflows:pi-subagent-model-preferences`, update `rendering/pi-workflows:pi-subagent-model-routing`, update `rendering/pi-workflows:pi-subagent-model-wizard`
- 2026-07-29: Applied; operations: update `rendering/pi-runtime:pi-extension-target-render`, update `rendering/pi-runtime:pi-real-runtime-smoke`
