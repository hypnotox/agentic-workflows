...
- [ADR-0031: Invariant Retirement via Successor ADR](0031-invariant-retirement-via-successor-adr.md) (Superseded)
- [ADR-0113: Em-dash-free shipped templates](0113-em-dash-free-shipped-templates.md) (Superseded)
...
- ADR-0007: item 3 refined by ADR-0008; slug `invariants-implemented-only` superseded by ADR-0134
...
- ADR-0014: slug `domain-index-matches-domains` superseded by ADR-0133
...
- ADR-0023: item 2 superseded by ADR-0032; item 3 superseded by ADR-0032; item 4 refined by ADR-0032; slug `setup-guards-hookspath` superseded by ADR-0032; slug `uninstall-removes-lock-tracked` superseded by ADR-0032
...
- ADR-0038: item 1 refined by ADR-0132
...
- ADR-0064: slug `invariant-markers-derived` superseded by ADR-0134; slug `invariant-markers-in-confighash` superseded by ADR-0134
...
- ADR-0104: slug `context-surfaces-tiered-pitfalls` superseded by ADR-0134; slug `context-surfaces-tiered-plans` superseded by ADR-0134; slug `context-tier1-governs` superseded by ADR-0106; slug `context-tier2-topical` superseded by ADR-0109; slug `context-tier3-collapsed` superseded by ADR-0134
- ADR-0105: slug `absent-testglobs-source-fallback` superseded by ADR-0134; slug `bare-touches-note` superseded by ADR-0134; slug `dangling-marker-advisory` superseded by ADR-0134
- ADR-0106: slug `context-invariant-backed-labeled` superseded by ADR-0134; slug `context-surfaces-marker-notes` superseded by ADR-0134; slug `context-tier1-marker-union` superseded by ADR-0134
- ADR-0109: slug `context-tier2-precise-tag` superseded by ADR-0134
...
- ADR-0120: item 3 superseded by ADR-0128; item 4 refined by ADR-0128; item 5 refined by ADR-0128; item 9 refined by ADR-0136; item 10 refined by ADR-0129; slug `active-md-supersedence-rendering` superseded by ADR-0128; slug `context-annotates-superseded-anchors` superseded by ADR-0135; slug `retires-invariants-key-refused` superseded by ADR-0135; slug `supersession-backpointer` superseded by ADR-0128; slug `supersession-conflict-advisory` superseded by ADR-0128; slug `supersession-flavour-exclusive` superseded by ADR-0128; slug `supersession-full-symmetry` superseded by ADR-0128; slug `supersession-token-ref-validity` superseded by ADR-0135; slug `token-retirement-dangling-errors` superseded by ADR-0135; slug `token-retirement-implemented-only` superseded by ADR-0135
...
- ADR-0128: slug `active-md-annotates-superseded-anchors` superseded by ADR-0135; slug `refines-token-never-covers` superseded by ADR-0135; slug `supersession-backpointer-any-status` superseded by ADR-0135; slug `supersession-contested-anchor-advisory` superseded by ADR-0135; slug `supersession-coverage-derives-status` superseded by ADR-0135; slug `supersession-coverage-implemented-only` superseded by ADR-0135; slug `supersession-keys-refused` superseded by ADR-0135
- ADR-0129: slug `active-md-chains-one-to-many` superseded by ADR-0135; slug `domain-index-surfaces-partial` superseded by ADR-0135; slug `supersession-graph-acyclic` superseded by ADR-0135; slug `supersession-model-anchor-nodes` superseded by ADR-0135; slug `supersession-model-derives-state` superseded by ADR-0135
- ADR-0131: slug `citation-check-decision-scoped` superseded by ADR-0135; slug `citation-check-exempts-code-spans` superseded by ADR-0135; slug `citation-check-exempts-proposed-target` superseded by ADR-0135; slug `citation-check-exempts-self-citation` superseded by ADR-0135; slug `citation-check-exempts-unslugged-bullet` superseded by ADR-0135; slug `citation-check-item-shapes` superseded by ADR-0135; slug `citation-check-slug-claims-per-carrier` superseded by ADR-0135; slug `citation-check-slug-spellings` superseded by ADR-0135; slug `citation-check-verb-forms` superseded by ADR-0135; slug `cites-token-suppresses-citation-check` superseded by ADR-0135; slug `cites-token-uncounted` superseded by ADR-0135; slug `cites-token-unrendered` superseded by ADR-0135; slug `render-active-md-grouped-or-placeholder` superseded by ADR-0135
