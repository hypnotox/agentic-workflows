...
- [ADR-0135: ADR Lifecycle and Checked Current-State Impacts](0135-adr-lifecycle-and-checked-current-state-impacts.md) (Proposed)
- [ADR-0136: Project-Atomic Migration to Current-State Authority](0136-project-atomic-migration-to-current-state-authority.md) (Proposed)
