...
date: 2026-07-31
---
# ADR-0191: Replace the global state sequence with ADR-number provenance order
...
10. Both added claims land as `Backing: test`, with proof markers on `internal/currentstate` tests:
    ...
    batch retained. Each add lands with ADR-0191 as Origin; each updated claim preserves its Origin
    and prior revisions and gains ADR-0191 in `Revised-by` in the same transaction.
...
- 2026-07-31: Amended; content-sha256: e70ceaf522822e2e543ba2d7abdbac9936e810d9ed1c4692a991bf1e82504f73
- 2026-07-31: Applied; operations: update `invariants/current-state-authority:update-requires-substance`
- 2026-07-31: Implemented; content-sha256: e70ceaf522822e2e543ba2d7abdbac9936e810d9ed1c4692a991bf1e82504f73
