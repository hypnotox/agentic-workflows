...
- 2026-07-30: Applied; operations: add `config/configuration:severity-not-configurable`, add `config/migrations-and-locks:severity-keys-dropped`
- 2026-07-30: Applied; operations: add `tooling/audit-commands:severity-single-spelling`, add `invariants/topics-and-markers:coverage-evaluation-selects-checks`
- 2026-07-30: Applied; operations: add `invariants/current-state-authority:currentstate-handshake-findings-unranked`
