...
date: 2026-07-30
---
# ADR-0183: Drop configurable severity and unify the finding rank
...
- 2026-07-30: Applied; state-sequence: 93; operations: add `config/configuration:severity-not-configurable`, add `config/migrations-and-locks:severity-keys-dropped`
- 2026-07-30: Applied; state-sequence: 94; operations: add `tooling/audit-commands:severity-single-spelling`, add `invariants/topics-and-markers:coverage-evaluation-selects-checks`
- 2026-07-30: Applied; state-sequence: 95; operations: add `invariants/current-state-authority:currentstate-handshake-findings-unranked`
- 2026-07-30: Implemented; content-sha256: a0c621987223c8d720be545d5224fc1d70fb4f0df5614879a3379a40406fb760
