...
- 2026-07-31: Applied; operations: add `tooling/effort-management:default-worktree-creation`, update `tooling/effort-management:effort-record-authority`, update `tooling/effort-management:managed-worktree-lifecycle`, update `tooling/cli:effort-command-contract`
- 2026-07-31: Applied; operations: update `rendering/guide-and-doc-templates:working-memory-single-home`, update `rendering/workflow-skill-templates:memory-checkpoint-chain-coverage`
- 2026-07-31: Applied; operations: update `rendering/pi-workflows:pi-session-handoff-public-contract`
