...
Proposed whose commit also mutates the ADR's digest-covered sections. Since ADR-0186 the
...
commit rather than racing a freeze (ADR-0154, ADR-0186; 2026-07-23, 2026-07-30).
