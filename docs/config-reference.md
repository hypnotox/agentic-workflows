...
| `docs` | string list | empty at init (the always-on docs are not listed here) | 5 enabled | Enabled toggleable docs (architecture, testing, development, …). The always-on docs — the agent guide, workflow, this reference — render regardless and are not listed here. | Always. |
