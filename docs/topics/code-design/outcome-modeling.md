...
**Applicability:** Global topic within owning domain selectors `internal/execution/**`, `internal/presentation/**`. Run `awf topic code-design/outcome-modeling --coverage` for current matched paths and marker sites.
