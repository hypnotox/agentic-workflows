...
**Applicability:** Owning domain selectors: `internal/config/**`, `internal/configspec/**`, `internal/manifest/**`, `internal/migrate/**`, `internal/pathglob/**`. Topic selectors: `internal/manifest/**`, `internal/migrate/**`. Both domain and topic selectors must match. Run `awf topic config/migrations-and-locks --coverage` for current matched paths and marker sites.
