...
**Applicability:** `internal/currentstate/**` within domain `internal/currentstate/**`, `internal/invariants/**` within domain `internal/currentstate/**`, `internal/currentstate/**` within domain `internal/invariants/**`, `internal/invariants/**` within domain `internal/invariants/**`, `internal/currentstate/**` within domain `internal/topic/**`, `internal/invariants/**` within domain `internal/topic/**`.
