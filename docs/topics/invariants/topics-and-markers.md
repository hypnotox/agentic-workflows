...
**Applicability:** `internal/topic/**` within domain `internal/currentstate/**`, `internal/topic/**` within domain `internal/invariants/**`, `internal/topic/**` within domain `internal/topic/**`.
