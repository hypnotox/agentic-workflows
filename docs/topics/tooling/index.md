...
- [Authority Queries](authority-queries.md): Read-only commands that expose current-state authority and decision history without duplicating code navigation.
