...
**Applicability:** `internal/render/**` within domain `internal/render/**`, `internal/refs/**` within domain `internal/render/**`, `internal/render/**` within domain `internal/catalog/**`, `internal/refs/**` within domain `internal/catalog/**`, `internal/render/**` within domain `internal/project/**`, `internal/refs/**` within domain `internal/project/**`, `internal/render/**` within domain `internal/refs/**`, `internal/refs/**` within domain `internal/refs/**`, `internal/render/**` within domain `templates/**`, `internal/refs/**` within domain `templates/**`.
