...
**Applicability:** `internal/project/**` within domain `internal/render/**`, `internal/project/**` within domain `internal/catalog/**`, `internal/project/**` within domain `internal/project/**`, `internal/project/**` within domain `internal/refs/**`, `internal/project/**` within domain `templates/**`.
