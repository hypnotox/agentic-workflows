...
**Applicability:** `internal/catalog/**` within domain `internal/render/**`, `internal/catalog/**` within domain `internal/catalog/**`, `internal/catalog/**` within domain `internal/project/**`, `internal/catalog/**` within domain `internal/refs/**`, `internal/catalog/**` within domain `templates/**`.
