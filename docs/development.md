...
<!-- awf:edit setup — default; create .awf/docs/parts/development/setup.md to override -->
## Setup
...
<!-- awf:edit command-runner — default; create .awf/docs/parts/development/command-runner.md to override -->
## Command runner
...
<!-- awf:edit dependencies — default; create .awf/docs/parts/development/dependencies.md to override -->
## Dependencies
