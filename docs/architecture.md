...
<!-- awf:edit overview — from .claude/awf/docs/parts/architecture/overview.md -->
## Overview
...
<!-- awf:edit components — from .claude/awf/docs/parts/architecture/components.md -->
## Components
...
<!-- awf:edit data-flow — from .claude/awf/docs/parts/architecture/data-flow.md -->
## Data flow
...
<!-- awf:edit dependencies — from .claude/awf/docs/parts/architecture/dependencies.md -->
## Key dependencies
