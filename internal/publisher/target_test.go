...
func TestPiRealRuntimeSmoke(t *testing.T) {
	if os.Getenv("AWF_PI_RUNTIME_SMOKE") != "1" {
		t.Skip("Pi host lane skipped; run './x pi-test run' alone or './x gate' to include it")
	}
	assertPiRuntimeSmoke(t)
}
