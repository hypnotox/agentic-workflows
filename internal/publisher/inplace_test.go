...
func TestReplaceLocalDocumentBodyPreservesOwnedShell(t *testing.T) {
	original := "<!-- GENERATED by awf: do not edit -->\n# Incident response\n\n<!-- awf:edit-in-place body: your edits -->\n\nold body\n"
	edited, err := ReplaceLocalDocumentBody([]byte(original), "new body\n\nwith spacing")
	if err != nil {
		t.Fatal(err)
	}
	want := "<!-- GENERATED by awf: do not edit -->\n# Incident response\n\n<!-- awf:edit-in-place body: your edits -->\n\nnew body\n\nwith spacing\n"
	if string(edited) != want {
		t.Fatalf("edited local document = %q, want %q", edited, want)
	}
	reset, err := ReplaceLocalDocumentBody(edited, "")
	if err != nil {
		t.Fatal(err)
	}
	wantReset := "<!-- GENERATED by awf: do not edit -->\n# Incident response\n\n<!-- awf:edit-in-place body: your edits -->\n\n"
	if string(reset) != wantReset {
		t.Fatalf("reset local document = %q, want %q", reset, wantReset)
	}
	if _, err := ReplaceLocalDocumentBody([]byte("# no boundary\n"), "body"); err == nil {
		t.Fatal("missing local body boundary accepted")
	}
}
