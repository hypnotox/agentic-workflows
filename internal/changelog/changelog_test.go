...
func TestLoadFromEmbed(t *testing.T) {
	...
	// invariant: tooling/changelog-and-release:changelog-embed-decodes (TestLoadFromEmbed)
	if len(entries) == 0 {
...
func TestRange(t *testing.T) {
	...
	// invariant: tooling/changelog-and-release:changelog-range-chronological (TestRange)
