		...
		Children: []Command{
			...
			{Name: "memory", Summary: "Read and update bounded effort memory", MaxPos: 0,
				...
				Children: []Command{
					...
					{Name: "edit", Summary: "Apply exact body replacements", BoolFlags: []string{"--json"}, ValueFlags: []string{"--owner"}, MinPos: 1, MaxPos: 1,
						Help: Help{Usage: []string{"awf effort memory edit <slug>", "awf effort memory edit <slug> --owner <uuid> --json"}, Description: "Read one closed JSON edit request from stdin and atomically replace exact original-body text.", Positionals: []HelpItem{{Name: "<slug>", Description: "immutable effort slug"}}, Options: []HelpItem{{Name: "--owner", Description: "<uuid> advisory activity owner"}, {Name: "--json", Description: "require the owner-scoped protocol-1 reply"}}}},
					{Name: "update", Summary: "Update memory phase or next action", BoolFlags: []string{"--json"}, ValueFlags: []string{"--phase", "--next", "--owner"}, MinPos: 1, MaxPos: 1,
						Help: Help{Usage: []string{"awf effort memory update <slug> [--phase <text>] [--next <text>]", "awf effort memory update <slug> [--phase <text>] [--next <text>] --owner <uuid> --json"}, Description: "Update one or both mutable memory metadata fields. At least one of --phase and", Details: []string{"--next is required."}, Positionals: []HelpItem{{Name: "<slug>", Description: "immutable effort slug"}}, Options: []HelpItem{{Name: "--phase", Description: "<text> replacement phase metadata"}, {Name: "--next", Description: "<text> replacement next-action metadata"}, {Name: "--owner", Description: "<uuid> advisory activity owner"}, {Name: "--json", Description: "require the owner-scoped protocol-1 reply"}}}},
				},
			},
