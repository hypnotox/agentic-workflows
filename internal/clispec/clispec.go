		...
		Children: []Command{
			...
			{Name: "repo", Summary: "Verify repository properties", MaxPos: -1,
				...
				Children: []Command{
					...
					{Name: "prose", Summary: "Enforce punctuation restraint in tracked text, blocking", MaxPos: 0,
						Help: Help{Usage: []string{"awf check repo prose"}, Description: "Reject en dashes and paragraphs with more than two em dashes in tracked text; binary files are skipped."}},
