...
var Commands = []Command{
	...
	},
	{
		...
		Help: Help{
			...
			Positionals: []HelpItem{{Name: "<kind>", Description: "artifact kind: doc, skill, or domain"}, {Name: "<name>", Description: "catalog, configured-domain, or configured-local-document name"}, {Name: "<part>", Description: "declared part name; local documents expose only body"}},
...

	{
		...
		Children: []Command{
			{Name: "topic", Summary: "Read one topic or claim authority projection", BoolFlags: []string{"--references", "--coverage"}, MinPos: 1, MaxPos: 1,
	...
	},
	{
		...
		Children: []Command{{Name: "topic", Summary: "Resolve topic authority for paths or the whole repository", BoolFlags: []string{"--uncovered"}, MinPos: 0, MaxPos: -1,
