...
var Standard = &Catalog{
	Skills: map[string]SkillSpec{
		...
		"tdd": {Profile: WorkflowProfile{Kind: WorkflowSupport, Purpose: "Establish the strongest practical durable oracle for a behavior change.", Trigger: "Use when establishing durable verification evidence before implementation.", UsuallyFollows: []string{"bugfix", "debugging"}, CommonFollowUps: []string{"executing-direct", "executing-plans"}},
