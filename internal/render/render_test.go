...
func TestRenderDefault(t *testing.T) {
	...
	// invariant: rendering/render-engine:no-section-marker-leak (TestRenderDefault)
...
func TestEditPointerStub(t *testing.T) {
	...
	// invariant: rendering/render-engine:section-edit-pointer (TestEditPointerStub)
...
func TestAssembleInPlaceSection(t *testing.T) {
	...
	// invariant: rendering/render-engine:in-place-pointer-distinct (TestAssembleInPlaceSection)
...
func TestCommentStyleForSourceAndPointers(t *testing.T) {
	...
	// invariant: rendering/render-engine:in-place-pointer-distinct (TestCommentStyleForSourceAndPointers)
