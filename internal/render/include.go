...
// touches-state: rendering/render-engine:include-splice - include-directive splice site; proof in include_test.go
// touches-state: rendering/render-engine:include-missing-fails - missing-partial hard error; proof in include_test.go
// touches-state: rendering/render-engine:include-no-nested - nested-include rejection; proof in include_test.go
// touches-state: rendering/render-engine:include-no-sections - section-marker-in-partial rejection; proof in include_test.go
