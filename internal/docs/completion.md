...
Default to independent retrospective review for long-running or multi-stage work whose accumulated history merits separate judgment, and for smaller work with meaningful issues, even if resolved. Routine, well-understood and uniform mechanical work can use direct retrospective review unless meaningful issues arose; size or ordinary expected test failures alone do not trigger delegation. Obtain or reuse a directly applicable fresh-context review under the delegation and reconciliation rules above. When independence is warranted but unavailable or prohibited, review directly and disclose that limitation.
