...
Use the repository's documented AWF runner; examples below use `./awf`. Read this workflow when it becomes relevant and reuse it during the task. For change definitions and ADRs, use `docs changes`; before completing or integrating implementation work, use `docs completion`.
