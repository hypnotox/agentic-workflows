...
// invariant: rendering/guide-and-doc-templates:no-doc-path-vars (TestNoDocPathVarsInTemplates)
...
// invariant: rendering/templates:commit-scope-single-storage (TestCommitScopeSingleStorage)
