...
var keys = []Entry{
	...
	{Path: "workflowTelemetry.retention.maxCompletedEffortAgeDays", Type: "non-negative integer", Default: "90", Description: "Maximum age in days for terminal effort metrics; zero disables age-based retention.", Availability: "Consumed by workflow metrics retention."},
	{Path: "workflowTelemetry.retention.maxCompletedEffortCount", Type: "non-negative integer", Default: "100", Description: "Maximum number of terminal efforts retained repository-wide; zero disables count-based retention.", Availability: "Consumed by workflow metrics retention."},
	{Path: "workflowTelemetry.widget.enabled", Type: "bool", Default: "true", Description: "Shows the compact active-effort Pi widget when the dashboard target is installed.", Availability: "Consumed by the Pi workflow dashboard."},
	{Path: "workflowTelemetry.widget.showCost", Type: "bool", Default: "true", Description: "Shows cost in the compact widget without changing collection or export.", Availability: "Consumed by the Pi workflow dashboard widget."},
	{Path: "workflowTelemetry.diagnostics.heuristicsEnabled", Type: "bool", Default: "true", Description: "Enables heuristic workflow findings; exact diagnostics remain enabled when false.", Availability: "Consumed by workflow diagnosis."},
	{Path: "workflowTelemetry.diagnostics.minimumBaselineSamples", Type: "positive integer", Default: "10", Description: "Minimum comparable completed-effort sample count required for historical heuristic baselines.", Availability: "Consumed by workflow diagnosis."},
	{Path: "workflowTelemetry.diagnostics.baselinePercentile", Type: "integer from 1 through 100", Default: "95", Description: "Nearest-rank percentile used for historical heuristic baselines.", Availability: "Consumed by workflow diagnosis."},
	{Path: "workflowTelemetry.diagnostics.thresholds.phaseReentryCount", Type: "positive integer", Default: "2", Description: "Inclusive absolute threshold for reentries into a named phase.", Availability: "Consumed when heuristic diagnostics are enabled."},
	{Path: "workflowTelemetry.diagnostics.thresholds.phaseDurationSeconds", Type: "positive integer", Default: "14400", Description: "Inclusive absolute threshold for phase duration in seconds.", Availability: "Consumed when heuristic diagnostics are enabled."},
	{Path: "workflowTelemetry.diagnostics.thresholds.phaseTokens", Type: "positive integer", Default: "200000", Description: "Inclusive absolute threshold for tokens used in one phase interval.", Availability: "Consumed when heuristic diagnostics are enabled."},
	{Path: "workflowTelemetry.diagnostics.thresholds.compactionCount", Type: "positive integer", Default: "3", Description: "Inclusive absolute threshold for compactions in one effort.", Availability: "Consumed when heuristic diagnostics are enabled."},
	{Path: "workflowTelemetry.diagnostics.thresholds.handoffCount", Type: "positive integer", Default: "3", Description: "Inclusive absolute threshold for handoffs in one effort.", Availability: "Consumed when heuristic diagnostics are enabled."},
	{Path: "workflowTelemetry.diagnostics.thresholds.toolFailureCount", Type: "positive integer", Default: "3", Description: "Inclusive absolute threshold for categorized tool failures in an implementation segment.", Availability: "Consumed when heuristic diagnostics are enabled."},
	{Path: "workflowTelemetry.diagnostics.thresholds.gateFailureCount", Type: "positive integer", Default: "2", Description: "Inclusive absolute threshold for failed gates in an implementation segment.", Availability: "Consumed when heuristic diagnostics are enabled."},
	{Path: "workflowTelemetry.diagnostics.thresholds.cacheReadPercentBelow", Type: "integer from 0 through 100", Default: "10", Description: "Inclusive lower threshold for cache-read percentage when the token denominator is positive.", Availability: "Consumed when heuristic diagnostics are enabled."},
	{Path: "workflowTelemetry.diagnostics.thresholds.subagentQueueWaitSeconds", Type: "positive integer", Default: "60", Description: "Inclusive absolute threshold for one subagent queue wait in seconds.", Availability: "Consumed when heuristic diagnostics are enabled."},
