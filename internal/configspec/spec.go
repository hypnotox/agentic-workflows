...
var keys = []Entry{
	...
	{Path: "workflowTelemetry.widget.enabled", Type: "bool", Default: "true", Description: "Shows the compact active-effort Pi telemetry widget when the Pi target is installed.", Availability: "Consumed by the Pi telemetry extension."},
	{Path: "workflowTelemetry.widget.showCost", Type: "bool", Default: "true", Description: "Shows cost in the compact widget without changing collection or export.", Availability: "Consumed by the Pi telemetry widget."},
