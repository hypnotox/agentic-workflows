...
// invariant: adr-system/adr-lifecycle:numbering-transition-mode (TestCheckPairNumberingTransition)
...
// invariant: adr-system/adr-lifecycle:numbering-transition-mode (TestCheckPairNumberingComposesWithADeclaredUpdate)
...
// invariant: adr-system/adr-lifecycle:numbering-transition-mode (TestCheckPairNumberingSubstitutionEdgeShapes)
...
// invariant: adr-system/adr-lifecycle:numbering-transition-mode (TestCheckPairSubstitutionRequiresThePairedNumbering)
...
// invariant: adr-system/adr-lifecycle:numbering-transition-mode (TestCheckPairDeletedPendingADR)
...
// invariant: adr-system/adr-lifecycle:adr-number-immutable (TestCheckPairRefusesAReassignedNumber)
...
// invariant: adr-system/adr-lifecycle:numbering-transition-mode (TestCheckPairRanksPendingBatchesLast)
