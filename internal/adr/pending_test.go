...
// invariant: adr-system/adr-lifecycle:pending-adr-slug-identity (TestParseV3AcceptsBothIdentityForms)
...
// invariant: adr-system/adr-lifecycle:corpus-single-identity-key (TestParseDirRefusesStraysAndCarriesPendingRecords)
...
// invariant: adr-system/adr-lifecycle:adr-amendable-until-terminal (TestV3ContentAmendsUntilTerminalStatus)
...
// invariant: adr-system/adr-lifecycle:applied-history-events-append-only (TestV3HistoryIsPrefixAppendOnly)
...
// invariant: adr-system/adr-lifecycle:adr-status-enum-and-matrix (TestV3FollowsTheGovernedStatusMatrix)
...
// invariant: adr-system/adr-lifecycle:corpus-single-identity-key (TestNewCorpusReportsDuplicateIdentitiesAndStillPopulates)
...
// invariant: adr-system/adr-lifecycle:pending-adr-slug-identity (TestFileIdentityClassifiesDecisionBasenames)
...
// invariant: adr-system/adr-lifecycle:pending-adr-slug-identity (TestRenderIndexMDSortsNumberedBeforePending)
...
// not the constant.
// invariant: adr-system/adr-lifecycle:pending-adr-slug-identity (TestNumberedIdentityFormIsExactlyFourDigits)
