...
// invariant: config/migrations-and-locks:upgrade-migrates-supersession-keys (TestSupersessionKeysMigration)
...
// invariant: config/migrations-and-locks:upgrade-migrates-supersession-keys (TestSupersessionKeysOffsetsSurvivePassOne)
...
// invariant: config/migrations-and-locks:upgrade-migrates-supersession-keys (TestSupersessionKeysRefusesUnresolvableClaim)
...
// invariant: config/migrations-and-locks:upgrade-migrates-supersession-keys (TestSupersessionKeysEdgeShapes)
...
// invariant: config/migrations-and-locks:upgrade-migrates-supersession-keys (TestSupersessionKeysChainedSupersession)
