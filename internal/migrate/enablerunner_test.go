...
// invariant: rendering/companion-scripts:runner-singleton-toggle (TestEnableRunnerAdds)
...
// invariant: rendering/companion-scripts:runner-singleton-toggle (TestEnableRunnerKeepsExplicitOptOut)
