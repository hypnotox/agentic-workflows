...
// invariant: config/migrations-and-locks:upgrade-migrates-retirements (TestRetirementTokensEmptyKeyAndExistingBackpointer)
...
// invariant: config/migrations-and-locks:upgrade-migrates-retirements (TestRetirementTokensCarrierTargetAndTrailingDecision)
...
// invariant: config/migrations-and-locks:upgrade-migrates-retirements (TestRetirementTokensLoudFailures)
