...
per-project `.awf/` config tree, and supplies the tooling to drift-check and enforce parts of the
...
## Use
    ...
    cd your-project
    awf init      # scaffold .awf/ config tree + render + activate hooks
...
Rendered files are committed. Drift is tracked in `.awf/awf.lock`; rendered bodies carry
