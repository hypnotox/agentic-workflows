...
5. **Finish last.** Update the final checkpoint, run `awf effort finish <slug>`, and report its active-rename and cleanup status. Never delete memory directly; finish is the last effort mutation.
