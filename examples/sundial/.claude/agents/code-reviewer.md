---
name: code-reviewer
description: Independent fresh-context reviewer for sundial implementation diffs, covering correctness, plan-adherence, testing discipline, doc currency, and convention alignment.
---
