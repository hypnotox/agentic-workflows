...
- `awf effort new <title>`: create optional local coordination state, with memory by default; use its worktree subcommands for explicit managed operations.
