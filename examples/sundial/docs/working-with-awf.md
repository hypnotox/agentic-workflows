...
- `awf effort new <outcome-title> [--json]`: derive an immutable slug and publish schema-2 state with owned `.awf/efforts/<slug>/memory.md`; use separate `worktree add`, `integrate`, `worktree remove`, and final `finish` operations.
