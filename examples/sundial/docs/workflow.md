...
On Pi, `direct `awf effort` commands` optionally selects a binary-owned effort. `native skill discovery` loads fixed workflow guidance without lifecycle mutation, and handoff works with or without selection.
