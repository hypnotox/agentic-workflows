...
On Pi, `/awf-effort` optionally selects a binary-owned effort. `awf_workflow` loads fixed workflow guidance without lifecycle mutation, and handoff works with or without selection.
