---
name: code-reviewer
description: Independent fresh-context reviewer for sundial implementation diffs, covering its universal review lenses from correctness through convention alignment.
---
