...
description: Use before any non-trivial sundial work (new feature, refactor, bug investigation that changes behaviour, workflow rule change). Explores intent, requirements, and design before any code or doc is written. Hands off to sundial-writing-plans or sundial-proposing-adr at the end.
---
...
7. **Decide the terminal step** based on the (reviewed) brainstorm result:
   ...
   - **Neither** → implement directly without a plan or ADR, then invoke `sundial-reviewing-impl`.
