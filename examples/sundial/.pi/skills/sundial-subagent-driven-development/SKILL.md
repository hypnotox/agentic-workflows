...
5. Validate the reported commit and clean checkout, then dispatch one report-only phase review. The parent owns focused settlement commits and checkpoints only after findings resolve.
