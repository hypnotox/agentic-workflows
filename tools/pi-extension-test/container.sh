...
test_command="c8 --all --include='.pi/extensions/awf-subagents/index.ts' --include='.pi/extensions/awf-subagents/runner.ts' --include='.pi/extensions/awf-subagents/model-routing.ts' --include='.pi/extensions/awf-handoff/index.ts' --include='.pi/extensions/awf-context-usage/index.ts' --include='.pi/extensions/awf-effort/index.ts' --include='.pi/extensions/awf-effort/client.ts' --exclude='tools/pi-extension-test/tests/*.ts' --check-coverage --lines=100 --functions=100 --branches=100 node --import tsx --test --experimental-test-isolation=none tools/pi-extension-test/tests/*.test.ts"
