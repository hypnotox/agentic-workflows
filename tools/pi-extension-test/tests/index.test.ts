...
test("profiles retain exact schemas, rendered contracts, routing selection, metadata, and commit policy", async()=>{
 ...
 const contexts:any[]=[{args:{task:"x"},parent:{model:h.ctx.model}},{args:{task:"x",breadth:"broad",detail:"analysis"},parent:{model:h.ctx.model}},{args:{task:"x"},parent:{model:h.ctx.model}},{args:{task:"x"},parent:{model:h.ctx.model}},{args:{task:"x"},parent:{model:h.ctx.model}},{args:{task:"x"},parent:{model:h.ctx.model}}];
