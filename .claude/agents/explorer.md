...
name: explorer
description: >
  Fresh-context exploration subagent for awf repository questions, handling one information need under a selected breadth and report detail.
...
<!-- awf:template-source templates/agents/explorer.md.tmpl#identity -->
...
<!-- awf:template-source templates/agents/explorer.md.tmpl#single-need -->
...
<!-- awf:template-source templates/agents/explorer.md.tmpl#breadth -->
...
<!-- awf:template-source templates/agents/explorer.md.tmpl#report-detail -->
...
<!-- awf:template-source templates/agents/explorer.md.tmpl#grounding-and-outcomes -->
...
<!-- awf:template-source templates/agents/explorer.md.tmpl#report-discipline -->
