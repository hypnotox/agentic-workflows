...
1. **application-batches**: every declared operation is assigned to a direct, first, middle, final, or canceled outcome; batch pairs are atomic, target IDs do not conflict within a pair, and sequences are consecutive.
