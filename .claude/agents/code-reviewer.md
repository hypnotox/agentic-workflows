---
name: code-reviewer
description: Specialised reviewer for awf implementation diffs — correctness, plan-adherence, testing discipline, doc currency, and convention alignment.
---
...
- docs/decisions/ACTIVE.md regenerated via go test ./internal/adrtools/ when ADR frontmatter changes
...
1. Apply mechanical and reasoned fixes directly via Edit as new commits; note rationale for reasoned fixes. Never `--amend` prior commits.
