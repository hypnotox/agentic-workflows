...
Find its block under the right section of ``. Read it: does it cite measured numbers (benchmarks, query timings, payload sizes)?
...
- Authoritative source for roadmap conventions: `` opening paragraph. This skill is a procedural pointer, not a contract restatement.
