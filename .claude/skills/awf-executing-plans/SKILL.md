...
<!-- awf:edit positioning — default; create .claude/awf/skills/parts/executing-plans/positioning.md to override -->
...
<!-- awf:edit when-to-invoke — default; create .claude/awf/skills/parts/executing-plans/when-to-invoke.md to override -->
## When to invoke
...
<!-- awf:edit procedure-resolve-plan — default; create .claude/awf/skills/parts/executing-plans/procedure-resolve-plan.md to override -->
...
<!-- awf:edit procedure-raise-concerns — default; create .claude/awf/skills/parts/executing-plans/procedure-raise-concerns.md to override -->
...
<!-- awf:edit procedure-per-task — default; create .claude/awf/skills/parts/executing-plans/procedure-per-task.md to override -->
...
<!-- awf:edit tdd-opt-in — default; create .claude/awf/skills/parts/executing-plans/tdd-opt-in.md to override -->


<!-- awf:edit gate-tier-detail — default; create .claude/awf/skills/parts/executing-plans/gate-tier-detail.md to override -->


<!-- awf:edit procedure-adr-final-commit — default; create .claude/awf/skills/parts/executing-plans/procedure-adr-final-commit.md to override -->
...
<!-- awf:edit procedure-non-adr-final-commit — default; create .claude/awf/skills/parts/executing-plans/procedure-non-adr-final-commit.md to override -->
...
<!-- awf:edit terminal-step — default; create .claude/awf/skills/parts/executing-plans/terminal-step.md to override -->
...
<!-- awf:edit project-invariants — default; create .claude/awf/skills/parts/executing-plans/project-invariants.md to override -->
...
<!-- awf:edit notes-gate — default; create .claude/awf/skills/parts/executing-plans/notes-gate.md to override -->
...
<!-- awf:edit notes-auto-commit — default; create .claude/awf/skills/parts/executing-plans/notes-auto-commit.md to override -->
- Auto-commit when green: tests pass + lint clean → commit without asking (per `docs/workflow.md`).

<!-- awf:edit notes-one-concern — default; create .claude/awf/skills/parts/executing-plans/notes-one-concern.md to override -->
- One concern per commit; if a task accumulates unrelated tweaks, split it.

<!-- awf:edit notes-docs-travel — default; create .claude/awf/skills/parts/executing-plans/notes-docs-travel.md to override -->
