...
<!-- awf:edit when-fires — default; create .claude/awf/skills/parts/reviewing-impl/when-fires.md to override -->
...
<!-- awf:edit sha-range-detection — default; create .claude/awf/skills/parts/reviewing-impl/sha-range-detection.md to override -->
...
<!-- awf:edit docs-only-check — default; create .claude/awf/skills/parts/reviewing-impl/docs-only-check.md to override -->
...
<!-- awf:edit dispatch-subagent — default; create .claude/awf/skills/parts/reviewing-impl/dispatch-subagent.md to override -->
...
<!-- awf:edit classify-route-findings — default; create .claude/awf/skills/parts/reviewing-impl/classify-route-findings.md to override -->
...
<!-- awf:edit apply-fixes-commit — default; create .claude/awf/skills/parts/reviewing-impl/apply-fixes-commit.md to override -->
...
<!-- awf:edit re-review-loop — default; create .claude/awf/skills/parts/reviewing-impl/re-review-loop.md to override -->
...
<!-- awf:edit notes — default; create .claude/awf/skills/parts/reviewing-impl/notes.md to override -->
