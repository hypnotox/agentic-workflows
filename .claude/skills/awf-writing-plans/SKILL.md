...
<!-- awf:edit positioning — default; create .claude/awf/skills/parts/writing-plans/positioning.md to override -->
...
<!-- awf:edit when-to-invoke — default; create .claude/awf/skills/parts/writing-plans/when-to-invoke.md to override -->
## When to invoke
...
<!-- awf:edit conventions-path — default; create .claude/awf/skills/parts/writing-plans/conventions-path.md to override -->
- **Path:** `docs/plans/YYYY-MM-DD-<kebab-topic>.md`. The date is today (ISO-8601).

<!-- awf:edit conventions-header — default; create .claude/awf/skills/parts/writing-plans/conventions-header.md to override -->
...
<!-- awf:edit conventions-tasks — default; create .claude/awf/skills/parts/writing-plans/conventions-tasks.md to override -->
...
<!-- awf:edit conventions-no-placeholders — default; create .claude/awf/skills/parts/writing-plans/conventions-no-placeholders.md to override -->
...
<!-- awf:edit gate-tier-note — default; create .claude/awf/skills/parts/writing-plans/gate-tier-note.md to override -->
...
<!-- awf:edit conventions-test-first — default; create .claude/awf/skills/parts/writing-plans/conventions-test-first.md to override -->
- **Test-first for bugs:** add a failing test as its own task before the fix task.

## Procedure

<!-- awf:edit procedure-confirm-scope — default; create .claude/awf/skills/parts/writing-plans/procedure-confirm-scope.md to override -->
...
<!-- awf:edit plan-template-ref — default; create .claude/awf/skills/parts/writing-plans/plan-template-ref.md to override -->


<!-- awf:edit procedure-write-plan — default; create .claude/awf/skills/parts/writing-plans/procedure-write-plan.md to override -->
...
<!-- awf:edit doc-currency-check — default; create .claude/awf/skills/parts/writing-plans/doc-currency-check.md to override -->


<!-- awf:edit self-review — default; create .claude/awf/skills/parts/writing-plans/self-review.md to override -->


<!-- awf:edit plan-commit-step — default; create .claude/awf/skills/parts/writing-plans/plan-commit-step.md to override -->


<!-- awf:edit terminal-step — default; create .claude/awf/skills/parts/writing-plans/terminal-step.md to override -->
...
<!-- awf:edit plan-lifecycle — default; create .claude/awf/skills/parts/writing-plans/plan-lifecycle.md to override -->
...
<!-- awf:edit plan-resync — default; create .claude/awf/skills/parts/writing-plans/plan-resync.md to override -->


<!-- awf:edit notes — default; create .claude/awf/skills/parts/writing-plans/notes.md to override -->
