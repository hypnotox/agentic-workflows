...
<!-- awf:edit positioning — default; create .claude/awf/skills/parts/proposing-adr/positioning.md to override -->
...
<!-- awf:edit when-to-invoke — default; create .claude/awf/skills/parts/proposing-adr/when-to-invoke.md to override -->
...
<!-- awf:edit conventions — default; create .claude/awf/skills/parts/proposing-adr/conventions.md to override -->
...
<!-- awf:edit procedure-number — default; create .claude/awf/skills/parts/proposing-adr/procedure-number.md to override -->
1. **Pick the next ADR number.** List `docs/decisions/NNNN-*.md` and take the maximum number plus one.

<!-- awf:edit procedure-write — default; create .claude/awf/skills/parts/proposing-adr/procedure-write.md to override -->
...
<!-- awf:edit state-doc-update — default; create .claude/awf/skills/parts/proposing-adr/state-doc-update.md to override -->
...
<!-- awf:edit procedure-predecessor-flip — default; create .claude/awf/skills/parts/proposing-adr/procedure-predecessor-flip.md to override -->
...
<!-- awf:edit readme-index-update — default; create .claude/awf/skills/parts/proposing-adr/readme-index-update.md to override -->
...
<!-- awf:edit invariants-rule — default; create .claude/awf/skills/parts/proposing-adr/invariants-rule.md to override -->
...
<!-- awf:edit procedure-regen — default; create .claude/awf/skills/parts/proposing-adr/procedure-regen.md to override -->
...
<!-- awf:edit procedure-commit — default; create .claude/awf/skills/parts/proposing-adr/procedure-commit.md to override -->
...
<!-- awf:edit autonomous-rule — default; create .claude/awf/skills/parts/proposing-adr/autonomous-rule.md to override -->
...
<!-- awf:edit terminal-step — default; create .claude/awf/skills/parts/proposing-adr/terminal-step.md to override -->
...
<!-- awf:edit notes — default; create .claude/awf/skills/parts/proposing-adr/notes.md to override -->
