...
<!-- awf:edit states — default; create .claude/awf/skills/parts/adr-lifecycle/states.md to override -->
...
<!-- awf:edit transitions — default; create .claude/awf/skills/parts/adr-lifecycle/transitions.md to override -->
...
<!-- awf:edit supersedence-full — default; create .claude/awf/skills/parts/adr-lifecycle/supersedence-full.md to override -->
### Full supersedence
...
<!-- awf:edit supersedence-partial — default; create .claude/awf/skills/parts/adr-lifecycle/supersedence-partial.md to override -->
...
<!-- awf:edit procedure-status-edit — default; create .claude/awf/skills/parts/adr-lifecycle/procedure-status-edit.md to override -->
...
<!-- awf:edit procedure-predecessor-flip — default; create .claude/awf/skills/parts/adr-lifecycle/procedure-predecessor-flip.md to override -->
...
<!-- awf:edit readme-index-update — default; create .claude/awf/skills/parts/adr-lifecycle/readme-index-update.md to override -->
...
<!-- awf:edit state-doc-update — default; create .claude/awf/skills/parts/adr-lifecycle/state-doc-update.md to override -->
...
<!-- awf:edit procedure-regen — default; create .claude/awf/skills/parts/adr-lifecycle/procedure-regen.md to override -->
...
<!-- awf:edit procedure-gate — default; create .claude/awf/skills/parts/adr-lifecycle/procedure-gate.md to override -->
...
<!-- awf:edit commit-templates — default; create .claude/awf/skills/parts/adr-lifecycle/commit-templates.md to override -->
...
<!-- awf:edit amendment-while-proposed — default; create .claude/awf/skills/parts/adr-lifecycle/amendment-while-proposed.md to override -->
...
<!-- awf:edit notes — default; create .claude/awf/skills/parts/adr-lifecycle/notes.md to override -->
