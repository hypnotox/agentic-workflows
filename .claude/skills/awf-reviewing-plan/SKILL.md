...
<!-- awf:edit when-fires — default; create .claude/awf/skills/parts/reviewing-plan/when-fires.md to override -->
...
<!-- awf:edit procedure — default; create .claude/awf/skills/parts/reviewing-plan/procedure.md to override -->
...
<!-- awf:edit artifact-path-detection — default; create .claude/awf/skills/parts/reviewing-plan/artifact-path-detection.md to override -->
...
<!-- awf:edit dispatch-subagent — default; create .claude/awf/skills/parts/reviewing-plan/dispatch-subagent.md to override -->
...
<!-- awf:edit classify-route-findings — default; create .claude/awf/skills/parts/reviewing-plan/classify-route-findings.md to override -->
...
<!-- awf:edit apply-fixes-commit — default; create .claude/awf/skills/parts/reviewing-plan/apply-fixes-commit.md to override -->
...
<!-- awf:edit re-review-loop — default; create .claude/awf/skills/parts/reviewing-plan/re-review-loop.md to override -->
...
<!-- awf:edit hand-off — default; create .claude/awf/skills/parts/reviewing-plan/hand-off.md to override -->
...
<!-- awf:edit notes — default; create .claude/awf/skills/parts/reviewing-plan/notes.md to override -->
