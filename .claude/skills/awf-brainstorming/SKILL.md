...
<!-- awf:edit preamble — default; create .claude/awf/skills/parts/brainstorming/preamble.md to override -->
...
<!-- awf:edit when-to-invoke — default; create .claude/awf/skills/parts/brainstorming/when-to-invoke.md to override -->
## When to invoke
...
<!-- awf:edit procedure — default; create .claude/awf/skills/parts/brainstorming/procedure.md to override -->
## Procedure
...
<!-- awf:edit example-clarifying-questions — default; create .claude/awf/skills/parts/brainstorming/example-clarifying-questions.md to override -->
...
<!-- awf:edit design-sections — default; create .claude/awf/skills/parts/brainstorming/design-sections.md to override -->
...
<!-- awf:edit no-spec-rule — default; create .claude/awf/skills/parts/brainstorming/no-spec-rule.md to override -->
...
<!-- awf:edit grounding-check-output-format — default; create .claude/awf/skills/parts/brainstorming/grounding-check-output-format.md to override -->
...
<!-- awf:edit grounding-check-dispatch-template — default; create .claude/awf/skills/parts/brainstorming/grounding-check-dispatch-template.md to override -->


<!-- awf:edit terminal-handoff — default; create .claude/awf/skills/parts/brainstorming/terminal-handoff.md to override -->
...
<!-- awf:edit definitions — default; create .claude/awf/skills/parts/brainstorming/definitions.md to override -->
## Definitions
...
<!-- awf:edit anti-patterns — default; create .claude/awf/skills/parts/brainstorming/anti-patterns.md to override -->
