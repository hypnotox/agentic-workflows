...
<!-- awf:edit when-fires — default; create .claude/awf/skills/parts/reviewing-adr/when-fires.md to override -->
...
<!-- awf:edit procedure — default; create .claude/awf/skills/parts/reviewing-adr/procedure.md to override -->
...
<!-- awf:edit artifact-path-detection — default; create .claude/awf/skills/parts/reviewing-adr/artifact-path-detection.md to override -->
...
<!-- awf:edit dispatch-subagent — default; create .claude/awf/skills/parts/reviewing-adr/dispatch-subagent.md to override -->
...
<!-- awf:edit classify-route-findings — default; create .claude/awf/skills/parts/reviewing-adr/classify-route-findings.md to override -->
...
<!-- awf:edit apply-fixes-commit — default; create .claude/awf/skills/parts/reviewing-adr/apply-fixes-commit.md to override -->
...
<!-- awf:edit re-review-loop — default; create .claude/awf/skills/parts/reviewing-adr/re-review-loop.md to override -->
...
<!-- awf:edit status-flip — default; create .claude/awf/skills/parts/reviewing-adr/status-flip.md to override -->
...
<!-- awf:edit hand-off-to-resync — default; create .claude/awf/skills/parts/reviewing-adr/hand-off-to-resync.md to override -->
...
<!-- awf:edit notes — default; create .claude/awf/skills/parts/reviewing-adr/notes.md to override -->
