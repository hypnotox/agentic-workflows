...
description: Use to write a change-specific implementation plan for a complex awf task under docs/plans. Enforces observable outcomes, authority, boundaries, ordering, focused evidence, and needed confinement. Terminal step invokes awf-reviewing-plan.
---
...
<!-- awf:template-source templates/skills/writing-plans/SKILL.md.tmpl#positioning -->
...
<!-- awf:template-source templates/skills/writing-plans/SKILL.md.tmpl#conventions-path -->
...
<!-- awf:template-source templates/skills/writing-plans/SKILL.md.tmpl#conventions-header -->
...
<!-- awf:template-source templates/skills/writing-plans/SKILL.md.tmpl#conventions-tasks -->
...
<!-- awf:template-source templates/skills/writing-plans/SKILL.md.tmpl#conventions-no-placeholders -->
...
<!-- awf:template-source templates/skills/writing-plans/SKILL.md.tmpl#gate-tier-note -->
...
<!-- awf:template-source templates/skills/writing-plans/SKILL.md.tmpl#plan-lifecycle -->
...
<!-- awf:template-source templates/skills/writing-plans/SKILL.md.tmpl -->
- Full plan review reads every ADR from parsed plan-level `adrs:`. If planning surfaces a new load-bearing decision or a correction would contradict linked authority, pause: invoke `awf-proposing-adr` (or amend a still-amendable ADR via `awf-adr-lifecycle`), complete ordinary ADR review first, then invoke ordinary `awf-reviewing-plan` for every affected linked Proposed plan. If implementation already started, reassess completed affected phases and renew their assurance before progression.

<!-- awf:template-source templates/skills/writing-plans/SKILL.md.tmpl#notes -->
