...
<!-- awf:template-source templates/skills/adr-lifecycle/SKILL.md.tmpl#states -->
...
<!-- awf:template-source templates/skills/adr-lifecycle/SKILL.md.tmpl#transitions -->
...
<!-- awf:template-source templates/skills/adr-lifecycle/SKILL.md.tmpl#state-changes -->
...
<!-- awf:template-source templates/skills/adr-lifecycle/SKILL.md.tmpl#procedure-status-edit -->
...
<!-- awf:template-source templates/skills/adr-lifecycle/SKILL.md.tmpl#procedure-claim-mutation -->
...
<!-- awf:template-source templates/skills/adr-lifecycle/SKILL.md.tmpl#state-doc-update -->
...
<!-- awf:template-source templates/skills/adr-lifecycle/SKILL.md.tmpl#procedure-regen -->
...
<!-- awf:template-source templates/skills/adr-lifecycle/SKILL.md.tmpl#amendment-until-terminal -->
...
V4 Decision items begin with a unique inline `decision: <lowercase-kebab-slug>` marker. Pre-V4 Decision items have no stable marker: canonical `#N` remains available only for frozen ADR navigation and is not current-authority or supersession syntax.
