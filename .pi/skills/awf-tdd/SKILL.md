---
name: awf-tdd
description: Use to establish the strongest practical durable oracle before a bug fix in awf, or to write a failing test before feature implementation when the missing behaviour is testable in isolation.
---
