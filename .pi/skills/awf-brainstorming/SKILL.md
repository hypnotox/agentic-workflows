...
1. Before ADR or plan authoring resolves a material decision, present the completed design or proportionate implementation outline, explicitly request user approval, then stop and wait. This approval boundary never creates an effort.
