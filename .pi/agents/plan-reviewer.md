...
Resync mode is triggered by the still-enabled `awf-reviewing-plan-resync` skill after a linked ADR review converges. Its purpose is to catch plan-vs-finalised-ADR drift; initial plan review already checks linked authority before the first plan commit.
