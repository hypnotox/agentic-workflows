...
<!-- awf:template-source templates/agents/adr-reviewer.md.tmpl -->
# adr-reviewer
...
<!-- awf:template-source templates/agents/adr-reviewer.md.tmpl#universal-lenses -->
...
<!-- awf:template-source templates/agents/adr-reviewer.md.tmpl#project-focus -->
...
**outcome-modeling-authority**: when the ADR changes how an outcome is surfaced, matched, or asserted, consult code-design/outcome-modeling and flag a design that branches on message substrings, reaches for a shallow os.Is* predicate, introduces an error identity without a branching consumer, or shapes a repository-state refusal outside the actionable outcome protocol
