...
**Chain skills** (invoke in order): `awf-brainstorming`, `awf-proposing-adr`, `awf-reviewing-adr`, `awf-writing-plans`, `awf-reviewing-plan`, `awf-reviewing-plan-resync`, `awf-executing-plans` / `awf-subagent-driven-development`, `awf-reviewing-impl`, `awf-retrospective`. **Task skills** (as needed): `awf-bugfix`, `awf-debugging`, `awf-refactor-coupling-audit`, `awf-tdd`.
