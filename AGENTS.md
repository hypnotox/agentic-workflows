...
- `awf-subagent-driven-development` (chain): Implement a plan through reviewed phase owners. Trigger: Use when a plan phase benefits from delegated implementation ownership. Usually follows: writing-plans, reviewing-plan. Common follow-ups: reviewing-impl, retrospective.
